...
function VerBlog() {
    ...
    return (
        <>
            {blogs?.map((blog) => (
                <Link
                    className="w-[40vh] h-[25vh] inline-block hover:shadow-xl ml-5 mr-5 mb-5 md:h-[35vh] lg:h-[45vh]"
                    key={blog.id}
                    to={`/blogs/${blog.id}`}
                >
                    <div className="bg-white rounded-xl w-full h-full shadow-md overflow-hidden">
                        <img
                            src={blog.image}
                            alt={blog.title}
                            className="h-20 w-full object-cover md:h-40 lg:h-56"
                        />
                            ...
                            <div className="flex justify-between">
                                ...
                                <p className="flex justify-center items-center text-gray-600">
                                    <img
                                        src="/user.svg"
                                        alt=""
                                        className="w-3 h-2 m-1 md:w-5 md:h-4"
                                    />

...
function LoginPage() {
  return (
    ...
    <div className='bg-white flex justify-center items-center h-[100vh] w-[100%]'>
      ...
      <div className='w-[50%] h-full bg-[url("/loginpage.jpg")] bg-cover'>
      ...
      <form className='w-[50%] flex items-center flex-col'>
          ...
          <h1 className='text-4xl font-bold mb-10'>Inicia Sesion</h1>
          ...
          <Button type='submit' className='bg-[#66997b] text-white w-[50%]' size='lg'> Iniciar Sesion </Button>
